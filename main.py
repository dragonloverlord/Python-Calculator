...
class CalcWindow(Gtk.Window):
    def __init__(self):
        ...
        self.MainContainer.attach(self.MainContainer.grid_container, 0, 0, 5, 7)
        ...
        self.MainContainer.grid_container.attach(self.MainContainer.grid_container.buttons_row_five, 0, 1, 5, 1)
        ...
        self.MainContainer.grid_container.buttons_row_five.attach(
            self.MainContainer.grid_container.buttons_row_five.button_power, 0, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_five.attach(
            self.MainContainer.grid_container.buttons_row_five.button_bitwise_invert, 1, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_five.attach(
            self.MainContainer.grid_container.buttons_row_five.button_bitwise_or, 2, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_five.attach(
            self.MainContainer.grid_container.buttons_row_five.button_lper, 3, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_five.attach(
            self.MainContainer.grid_container.buttons_row_five.button_rper, 4, 0, 1, 1)
        ...
        self.MainContainer.grid_container.attach(self.MainContainer.grid_container.buttons_row_six, 0, 2, 5, 1)
        ...
        self.MainContainer.grid_container.buttons_row_six.attach(
            self.MainContainer.grid_container.buttons_row_six.button_and, 0, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_six.attach(
            self.MainContainer.grid_container.buttons_row_six.button_is, 1, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_six.attach(
            self.MainContainer.grid_container.buttons_row_six.button_lshift, 2, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_six.attach(
            self.MainContainer.grid_container.buttons_row_six.button_rshift, 3, 0, 1, 1)

        self.MainContainer.grid_container.buttons_row_six.button_not_eq = Gtk.Button("!=")
        self.MainContainer.grid_container.buttons_row_six.button_not_eq.button_value = " != "
        self.MainContainer.grid_container.buttons_row_six.button_not_eq.connect("clicked", entryText)
        self.MainContainer.grid_container.buttons_row_six.attach(
            self.MainContainer.grid_container.buttons_row_six.button_not_eq, 4, 0, 1, 1)
        ...
        self.MainContainer.grid_container.attach(self.MainContainer.grid_container.buttons_row_one, 0, 3, 5, 1)
        ...
        self.MainContainer.grid_container.buttons_row_one.attach(
            self.MainContainer.grid_container.buttons_row_one.button_seven, 0, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_one.attach(
            self.MainContainer.grid_container.buttons_row_one.button_eight, 1, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_one.attach(
            self.MainContainer.grid_container.buttons_row_one.button_nine, 2, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_one.attach(
            self.MainContainer.grid_container.buttons_row_one.button_multiply, 3, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_one.attach(
            self.MainContainer.grid_container.buttons_row_one.button_divide, 4, 0, 1, 1)
        ...
        self.MainContainer.grid_container.attach(self.MainContainer.grid_container.buttons_row_two, 0, 4, 5, 1)
        ...
        self.MainContainer.grid_container.buttons_row_two.attach(
            self.MainContainer.grid_container.buttons_row_two.button_four, 0, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_two.attach(
            self.MainContainer.grid_container.buttons_row_two.button_five, 1, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_two.attach(
            self.MainContainer.grid_container.buttons_row_two.button_six, 2, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_two.attach(
            self.MainContainer.grid_container.buttons_row_two.button_plus, 3, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_two.attach(
            self.MainContainer.grid_container.buttons_row_two.button_minus, 4, 0, 1, 1)
        ...
        self.MainContainer.grid_container.attach(self.MainContainer.grid_container.buttons_row_three, 0, 5, 5, 1)
        ...
        self.MainContainer.grid_container.buttons_row_three.attach(
            self.MainContainer.grid_container.buttons_row_three.button_one, 0, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_three.attach(
            self.MainContainer.grid_container.buttons_row_three.button_two, 1, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_three.attach(
            self.MainContainer.grid_container.buttons_row_three.button_three, 2, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_three.attach(
            self.MainContainer.grid_container.buttons_row_three.button_no_remain, 3, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_three.attach(
            self.MainContainer.grid_container.buttons_row_three.button_just_remain, 4, 0, 1, 1)
        ...
        self.MainContainer.grid_container.attach(self.MainContainer.grid_container.buttons_row_four, 0, 6, 5, 1)
        ...
        self.MainContainer.grid_container.buttons_row_four.attach(
            self.MainContainer.grid_container.buttons_row_four.button_decimal_point, 0, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_four.attach(
            self.MainContainer.grid_container.buttons_row_four.button_zero, 1, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_four.attach(
            self.MainContainer.grid_container.buttons_row_four.button_clear, 2, 0, 1, 1)
        ...
        self.MainContainer.grid_container.buttons_row_four.attach(
            self.MainContainer.grid_container.buttons_row_four.button_enter, 3, 0, 2, 1)
